...
export default function Canvas({ sprites, onSpriteClick, selectedSprite }) {
  return (
    <div className="flex-1 relative bg-slate-900 overflow-hidden min-h-[300px] sm:min-h-[400px]">
      ...
      {sprites.map((sprite) => (
        ...
        >
          <div className="relative">
            ...
            >
              <div className="w-full h-full flex items-center justify-center text-white font-semibold text-lg sm:text-xl">
                {sprite.name[0]}
              </div>
            </div>
